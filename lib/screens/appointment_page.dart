                              ...
                              Expanded(
                                child: SizedBox(
                                  ...
                                  child: OutlinedButton(
                                    ...
                                    onPressed: () {
                                      final appointmentId = schedule['id'];

                                      setState(() {
                                        // نلاقي الموعد الأصلي ونعدّل حالته
                                        final index = schedules.indexWhere((element) => element['id'] == appointmentId);
                                        if (index != -1) {
                                          schedules[index]['status'] = 'cancel';
                                        }
                                      });

                                      print('Cancelled appointment ID: $appointmentId');
                                    },
                                    child: const Text(
                                      'Cancel',
                                      style: TextStyle(
                                  ...
                                  child: OutlinedButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      setState(() {
                                        final index = schedules.indexWhere((element) => element['id'] == appointmentId);
                                        if (index != -1) {
                                          schedules[index]['status'] = 'complete'; // أو أي حالة مناسبة
                                        }
                                      });

                                      print('Reschedule appointment ID: $appointmentId');
                                    },
                                    child: const Text(
                                      'Reschedule',
                                      style: TextStyle(
